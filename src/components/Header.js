...
const isMenuOpen = useSelector((store)=> store.app.isMenuOpen);
  ...
  return (
    <div className={'fixed top-0 w-screen bg-[#e5e2e2] flex flex-col sm:flex-row sm:justify-between items-center z-50 transition-all' + (!isMenuOpen ? " justify-center h-14" : " h-screen sm:h-14")}>
